								  	...
								  	<div class="">
								  		<dl>
								  			...
								  			<dd>
								  				...
								  				<!-- <input type="text" v-model="studyUpdata.birth" v-if="showNew"> -->
								  				<div v-if="showNew">
													<el-date-picker
								  			...
								  			<dd>
								  				...
								  				<input type="text" v-model="studyUpdata.native_place" v-if="showNew">
								  			</dd>
								  			<dt>现居地址：</dt>
								...
								<el-col :span="12">
									<div class="">
										<dl>
								  			<dt>监护人：</dt>
								  			<dd>
								  				<span v-if="!showNew" v-text="study.guardian"></span>
								  				<input type="text" v-model="studyUpdata.guardian" v-if="showNew">
								  			</dd>
								  			<dt>关系：</dt>
								  			<dd>
								  				<span v-if="!showNew" v-text="study.relation"></span>
								  				<input type="text" v-model="studyUpdata.relation" v-if="showNew">
								  			</dd>
								  			<dt>手机：</dt>
								  			<dd>
								  				<span v-if="!showNew" v-text="study.phone"></span>
								  				<input type="text" v-model="studyUpdata.phone" v-if="showNew">
								  			</dd>
								  			<dt>微信：</dt>
								  			<dd>
								  				<span v-if="!showNew" v-text="study.wx"></span>
								  				<input type="text" v-model="studyUpdata.wx" v-if="showNew">
								  			</dd>
								  			<dt>QQ：</dt>
								  			<dd>
								  				<span v-if="!showNew" v-text="study.qq"></span>
								  				<input type="text" v-model="studyUpdata.qq" v-if="showNew">
								  			</dd>
								  		</dl>
									</div>
								</el-col>
